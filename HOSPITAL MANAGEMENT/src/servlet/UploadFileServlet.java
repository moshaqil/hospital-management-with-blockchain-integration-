	...
	//file encrypted and store into filepath1
     ...
     filepath1 = editpath + "\\Medicalhealthrecord\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
		...
		tlfilebean up=new tlfilebean(); 
		
		up.setName(paramValues.get(0).toString());
        ...
        up.setGender(paramValues.get(4).toString());
            System.out.println("Category: "+paramValues.get(4)); 
            
        up.setAge(paramValues.get(6).toString());
            System.out.println("Category: "+paramValues.get(6)); 
            
        up.setPatientid(paramValues.get(8).toString());
            System.out.println("Category: "+paramValues.get(8));
            
        up.setAddress(paramValues.get(10).toString());
            System.out.println("Category: "+paramValues.get(10));
            
        up.setBloodgroup(paramValues.get(12).toString());
            System.out.println("Category: "+paramValues.get(12)); 
            
        up.setDoctorname(paramValues.get(14).toString());
            System.out.println("Category: "+paramValues.get(14)); 
            
        up.setDoctorid(paramValues.get(16).toString());
            System.out.println("Category: "+paramValues.get(16)); 
            
        up.setDoctorspecialist(paramValues.get(18).toString());
            System.out.println("Category: "+paramValues.get(18));
            
            up.setHospitalname(paramValues.get(20).toString());
            System.out.println("Category: "+paramValues.get(20));
            
            up.setHospitalid(paramValues.get(22).toString());
            System.out.println("Category: "+paramValues.get(20));
          
            up.setDescription(paramValues.get(24).toString());
            System.out.println("Category: "+paramValues.get(22));
            
            up.setPrescription(paramValues.get(26).toString());
            System.out.println("Category: "+paramValues.get(24));
