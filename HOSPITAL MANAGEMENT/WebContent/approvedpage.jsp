...
<body>
  <table>
      <caption>Approved Status</caption>
      <thead>
        <tr>
...
String nam = session.getAttribute("emaill").toString();
Connection con;


con=Connecttodata.create();
PreparedStatement ps=con.prepareStatement("SELECT * FROM `medicalrecord`.`appointmentform` where status='Approved' and email='"+nam+"' ");
 ...
 <tbody>
       ...
       <td><%=  rs.getString(11) %></td>
        ...
        <td><%=  rs.getString(13) %></td>
         ...
         <td>
		     <a href="userforward.jsp?id=<%=rs.getString(1)%>">
		     <button class="btn btn-Dark" onclick="myFunction()">Forward</button></a>
	     </td> 
	   <%--   <td>
