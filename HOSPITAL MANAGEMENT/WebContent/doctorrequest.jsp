...
<body>
<table>
      <caption>Doctor Request</caption>
      <thead>
        <tr>
...
PreparedStatement ps=con.prepareStatement("SELECT * FROM `medicalrecord`.`doctor` where status='apply' ");
...
%>
      ...
      <tbody>
        ...
        <td><%=  rs.getString(9) %></td>
          ...
          <td>
		     <a href="doctorrequestaccept.jsp?id=<%=rs.getString(1)%>">
		     <button class="btn btn-Dark" onclick="myFunction()">ACCEPT</button></a>
	     </td>
	     <td>
		     <a href="doctorrequestreject.jsp?id=<%=rs.getString(1)%>">
