...
@keyframes appear {
   ...
   const toggleMenu = () => {
    ...
    <body>
		...
		<nav class="navbar">
			<div class="logo">Welcome Hospital Management</div>
			<!-- <label for="search">
		...
		<nav class="menu">
			<a href="doctorrequest.jsp" style="animation-delay: .5s">Doctor Request</a>
			
			<!--  <a href="patientrequest.jsp" style="animation-delay: .3s">Patient Request</a> -->
		<a href="managementlogin.jsp" style="animation-delay: .4s">Logout</a>
